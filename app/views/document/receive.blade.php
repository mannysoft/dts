           ...
           @if(count($errors) > 1)
            ...
            <form action="" class="form-horizontal" method="post" id="myform">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="tracking_no" type="text" id="tracking_no" value="<?php echo Input::get('tracking_no');?>" autocomplete="off" class="">
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span12">
...
$(document).ready(function(){
	...
	$("#search").click(function(){
		...
		$('#success_message').hide();
		$('#doc_info').show()
		$('#doc_info').load("<?php echo Request::root()?>/document/info/" + $('#tracking_no').val());
		$('#history').load("<?php echo Request::root()?>/document/history/" + $('#tracking_no').val());
		$("#tracking_no").select();
