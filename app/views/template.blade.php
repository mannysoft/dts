...
<head>
    <meta charset="utf-8">
    <title>Document Tracking System 1.98</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="#">Document Tracking</a>
            ...
            <ul class="nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="{{ Request::root()}}/document/create">Create</a></li>
                  <li><a href="{{ Request::root()}}/document/receive">Receive</a></li>
                  <li><a href="{{ Request::root()}}/document/my">My Documents</a></li>
                </ul>
              </li>
